...
const _lazy_Gzzh7x = () => import('../renderer.mjs');
...
const handlers = [
  ...
  { route: '/api/_content/cache.1677366333320.json', handler: _zscNKH, lazy: false, middleware: false, method: "get" },
