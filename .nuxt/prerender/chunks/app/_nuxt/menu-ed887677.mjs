...
import { useSSRContext, defineComponent, mergeProps, withCtx, createTextVNode } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/vue/index.mjs';
import { _ as _export_sfc, b as useRoute } from '../server.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/vue/server-renderer/index.mjs';
import { _ as _imports_0 } from './marble-bg-1-a5365838.mjs';
...
import '../../renderer.mjs';
import 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full mx-auto py-6" }, _attrs))} data-v-442598a9><div class="relative w-full h-full grid items-center place-items-center" data-v-442598a9><div class="w-full h-full grid gap-4" data-v-442598a9><div class="absolute w-full h-full grid gap-2" data-v-442598a9><img class="w-full h-full object-cover"${ssrRenderAttr("src", _imports_0)} data-v-442598a9></div><div class="relative flex flex-col z-10 gap-8" data-v-442598a9><div class="absolute left-1/24 w-11/12 h-full text-container" data-v-442598a9></div><div class="relative w-full flex items-center justify-center flex-col gap-4" data-v-442598a9><div class="absolute w-11/12 h-1/2 bg-yellow-300 bg-opacity-50 translate-y-1/2 rounded-2xl" data-v-442598a9></div><div class="absolute w-11/12 h-1/2 bg-green-500 bg-opacity-20 translate-y-1/2 rounded-2xl" data-v-442598a9></div><div class="content py-8 bg-gray-800 text-light-800 rounded-2xl flex flex-col gap-4 items-center justify-center border-green-300 border-4 z-10 px-4" data-v-442598a9>`);
      _push(ssrRenderComponent(_component_Text, { h3: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`For the first night, for those that are there, we can eat together.`);
          } else {
            return [
              createTextVNode("For the first night, for those that are there, we can eat together.")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Text, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` wrap au saumon / accra de poisson / croque monsieur `);
          } else {
            return [
              createTextVNode(" wrap au saumon / accra de poisson / croque monsieur ")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Text, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`(salmon wrap, fish croquettes )`);
          } else {
            return [
              createTextVNode("(salmon wrap, fish croquettes )")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Text, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Papillote de poisson / Ratatouille`);
          } else {
            return [
              createTextVNode("Papillote de poisson / Ratatouille")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Text, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Tiramisu with fruit`);
          } else {
            return [
              createTextVNode("Tiramisu with fruit")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Text, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Coffee and breakfast will be provided the morning of the 2nd.`);
          } else {
            return [
              createTextVNode("Coffee and breakfast will be provided the morning of the 2nd.")
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/meals/menu.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const menu = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-442598a9"]]);

export { menu as default };
//# sourceMappingURL=menu-ed887677.mjs.map
