...
import { useSSRContext, defineComponent, ref, mergeProps, withCtx, createTextVNode, toDisplayString } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full mx-auto" }, _attrs))} data-v-0ebbba3a><div class="relative w-full h-full grid items-center place-items-center" data-v-0ebbba3a>`);
      ...
      _push(`<div class="absolute top-0 left-0 h-full w-full" data-v-0ebbba3a></div></div></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0ebbba3a"]]);

export { index as default };
//# sourceMappingURL=index.f52e6d9a.mjs.map
