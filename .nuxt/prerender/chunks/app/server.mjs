import { getCurrentInstance, defineAsyncComponent, version, toRef, isRef, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, computed, isReadonly, withCtx, nextTick, defineComponent, h, Suspense, Transition } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/vue/index.mjs';
...
import { composableNames, getActiveHead, createServerHead as createServerHead$1 } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/@unhead/shared/dist/index.mjs';
...
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, joinURL } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/ufo/dist/index.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/vue/server-renderer/index.mjs';
...
const LazyHero = defineAsyncComponent(() => import('./_nuxt/Hero-71f3ef09.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-2c7a9f31.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-013ea8d4.mjs').then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import('./_nuxt/ProseCode-29c4a64d.mjs').then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-b19583c0.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-05cd5a9f.mjs').then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-8773e9c6.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-035c6301.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-651aee59.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-dfe88799.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-df725d34.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-2d24bfaa.mjs').then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import('./_nuxt/ContentSlot-3f5aebbc.mjs').then((r) => r.default));
...
const LazyMarkdown = defineAsyncComponent(() => import('./_nuxt/Markdown-0fceba51.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-a6da68f7.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-283f82a8.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-c651bb03.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-ef7dbb66.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-dae06ba2.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-da47e0d5.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-6bc455b0.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-c72974a9.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-57feb5d9.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-58d267d5.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-1a1dae0e.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-4ad054a9.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-bcf64256.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-323b7db5.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-6a287fbf.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-973b4da7.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-a3b5d4b8.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-d96d4a8d.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-cd91d8aa.mjs').then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-ee07ca4b.mjs').then((m) => m.default || m)
  },
  {
    name: "article",
    path: "/article",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4f8d2b27.mjs').then((m) => m.default || m)
  },
  {
    name: "components",
    path: "/components",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/components-5e7368e3.mjs').then((m) => m.default || m)
  },
  {
    name: "flights",
    path: "/flights",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/gallery-a5b11ef6.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-7deee9a7.mjs').then((m) => m.default || m)
  },
  {
    name: "meals-groceries",
    path: "/meals/groceries",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/groceries-6f0764e4.mjs').then((m) => m.default || m)
  },
  {
    name: "meals-menu",
    path: "/meals/menu",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/menu-ed887677.mjs').then((m) => m.default || m)
  },
  {
    name: "meals-wedding",
    path: "/meals/wedding",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/wedding-d4f0bf4b.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projects-404292a6.mjs').then((m) => m.default || m)
  },
  {
    name: "travel-slug",
    path: "/travel/:slug(.*)*",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-426563d1.mjs').then((m) => m.default || m)
  },
  {
    name: "travel-bikes",
    path: "/travel/bikes",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/bikes-c1e386b0.mjs').then((m) => m.default || m)
  },
  {
    name: "travel-daytrips",
    path: "/travel/daytrips",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/daytrips-ab68987a.mjs').then((m) => m.default || m)
  },
  {
    name: "travel",
    path: "/travel",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-21372920.mjs').then((m) => m.default || m)
  },
  {
    name: "travel-toulouse",
    path: "/travel/toulouse",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/toulouse-b5c81b50.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth-8cf0a325.mjs')
};
...
const layouts = {
  default: () => import('./_nuxt/default-ef7f472f.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-b83a1ad4.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-2f223680.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useRouter as a, useRoute as b, createError as c, useHead as d, entry$1 as default, useNuxtApp as e, useState as f, defineNuxtRouteMiddleware as g, navigateTo as n, useRuntimeConfig as u };
