...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full mx-auto py-6" }, _attrs))} data-v-c5ac7c7f><div class="relative w-full h-full grid items-center place-items-center" data-v-c5ac7c7f><div class="w-full h-full grid gap-4" data-v-c5ac7c7f><div class="absolute w-full h-full grid gap-2" data-v-c5ac7c7f><img class="w-full h-full object-cover"${ssrRenderAttr("src", _imports_0)} data-v-c5ac7c7f></div><div class="relative flex flex-col z-10 gap-8 items-center justify-center top-14" data-v-c5ac7c7f><div class="absolute left-1/24 w-11/12 h-full text-container" data-v-c5ac7c7f></div><div class="relative w-full flex items-center justify-center flex-col gap-4" data-v-c5ac7c7f><div class="absolute w-11/12 h-1/2 bg-yellow-300 bg-opacity-50 translate-y-1/2 rounded-2xl" data-v-c5ac7c7f></div><div class="absolute w-11/12 h-1/2 bg-green-500 bg-opacity-20 translate-y-1/2 rounded-2xl" data-v-c5ac7c7f></div><div class="content py-8 bg-gray-800 text-light-800 rounded-2xl flex flex-col gap-4 items-center justify-center border-green-300 border-4 z-10 px-4" data-v-c5ac7c7f>`);
      _push(ssrRenderComponent(_component_Text, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`On Wednesday, July 5, 2023, we will be hosting our wedding celebration. More information to come regarding the menu. Expect food, drinks, dancing, and cheers!`);
          } else {
            return [
              createTextVNode("On Wednesday, July 5, 2023, we will be hosting our wedding celebration. More information to come regarding the menu. Expect food, drinks, dancing, and cheers!")
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/meals/wedding.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const wedding = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c5ac7c7f"]]);

export { wedding as default };
//# sourceMappingURL=wedding-d4f0bf4b.mjs.map
