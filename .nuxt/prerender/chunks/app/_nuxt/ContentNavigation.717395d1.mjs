import { d as useNuxtApp, i as useState, c as useHead, f as useCookie, a as __nuxt_component_0$1$1, _ as _export_sfc, h as componentName } from '../server.mjs';
import { useSSRContext, defineComponent, ref, onErrorCaptured, createElementBlock, defineAsyncComponent, toRefs, computed, useSlots, mergeProps, withCtx, createTextVNode, createVNode, createSlots, unref, renderSlot, toDisplayString, resolveComponent, createElementVNode, h } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/vue/index.mjs';
import { u as useAsyncData, j as jsonStringify } from './query.c432c7cc.mjs';
import { hash } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/ohash/dist/index.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.128ecb61.mjs';
import _sfc_main$7 from './index.ce8762a7.mjs';
import __nuxt_component_0$1 from './index.49bd2142.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.1abd9629.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import('./Hero.6ce3a493.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.4da27303.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.b6c3877f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.1c9c011d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.12782dca.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.5ca75ad5.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./FlatCard.3069e6f1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./Title.710aa7ce.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./index.3b90c409.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./index.bdd1ddff.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./Vpic.1c39cd0e.mjs').then((n) => n.H).then((c) => c.default || c));
defineAsyncComponent(() => import('./Vpic.1c39cd0e.mjs').then((n) => n.V).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => NavItem).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.82d09236.mjs').then((n) => n.N).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.82d09236.mjs').then((n) => n.a).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.6da7eb2b.mjs').then((n) => n.b).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.6da7eb2b.mjs').then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => Row).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.dc920627.mjs').then((n) => n.S).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.dc920627.mjs').then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.82d09236.mjs').then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.49bd2142.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentDoc.8ed7c232.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.8b4dc5ce.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentQuery.c2027c6b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRenderer.aa704435.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRendererMarkdown.b82d8fae.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentSlot.2bdb4d3d.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.0ddf0047.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.a692ecea.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH2.eacdac13.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH3.9397a54f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH4.bb4c6ae1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH5.d0d92811.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.f9f9c79b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.d3674250.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.ca647cb0.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.af6ad80f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.933817b3.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.89d80961.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.4f3ac97d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.4640a83a.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.6f1a8f19.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.aafaddcb.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.e4d49e41.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.1f793fec.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.8e7af3a8.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.717395d1.mjs.map
