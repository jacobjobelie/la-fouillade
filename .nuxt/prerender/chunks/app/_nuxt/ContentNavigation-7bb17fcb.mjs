import { u as useNuxtApp, b as useRuntimeConfig, g as useCookie, _ as __nuxt_component_0$3 } from './app.config-d99d58fe.mjs';
import { useSSRContext, defineComponent, ref, onErrorCaptured, createElementBlock, defineAsyncComponent, toRefs, computed, useSlots, mergeProps, withCtx, createTextVNode, createVNode, createSlots, unref, renderSlot, toDisplayString, resolveComponent, toRef, createElementVNode, h } from 'file:///Users/sam/Documents/Work/la-fouillade/node_modules/vue/index.mjs';
import { u as useAsyncData, q as queryContent, e as encodeQueryParams, j as jsonStringify } from './query-aca7ac1f.mjs';
import { f as useState, d as useSupabaseUser, u as useHead, _ as _export_sfc, a as useSupabaseToken, b as createClient, e as componentName } from '../server.mjs';
import { hash } from 'file:///Users/sam/Documents/Work/la-fouillade/node_modules/ohash/dist/index.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-16ea5da4.mjs';
import _sfc_main$9 from './index-76e6c31d.mjs';
import __nuxt_component_0$2 from './index-0ad9cbe7.mjs';
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderAttrs, ssrRenderAttr, ssrRenderStyle, ssrRenderList } from 'file:///Users/sam/Documents/Work/la-fouillade/node_modules/vue/server-renderer/index.mjs';
import { useField, Form } from 'file:///Users/sam/Documents/Work/la-fouillade/node_modules/vee-validate/dist/vee-validate.js';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-09eb017b.mjs').then((m) => m.generateNavigation);
...
const WithCover = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: _sfc_main$8
});
...
const NavItem = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: _sfc_main$6
});
...
const Row = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: _sfc_main$5
});
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["flex gap-4", { "has-error": !!unref(errorMessage), success: unref(meta).valid }]
      }, _attrs))} data-v-670e7c9d>`);
      if (!!__props.label) {
        _push(`<label${ssrRenderAttr("for", unref(name))} data-v-670e7c9d>${ssrInterpolate(__props.label)}</label>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<input class="outline focus:border-dark-400 w-full"${ssrRenderAttr("name", unref(name))}${ssrRenderAttr("id", unref(name))}${ssrRenderAttr("type", __props.type)}${ssrRenderAttr("value", unref(inputValue))}${ssrRenderAttr("placeholder", __props.placeholder)} data-v-670e7c9d><p class="help-message" style="${ssrRenderStyle(unref(errorMessage) || unref(meta).valid ? null : { display: "none" })}" data-v-670e7c9d>${ssrInterpolate(unref(errorMessage) || __props.successMessage)}</p></div>`);
    };
  }
});
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-670e7c9d"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function onSubmit(values) {
      ...
      await supabase.from("shouts").upsert([updates], {
        returning: "minimal"
    ...
    freshFetch();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_TextInput = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "" }, _attrs))}><div class=""><ul class="pl-0"><!--[-->`);
      ssrRenderList(unref(shouts), (s, idx) => {
        _push(`<li class="flex gap-2"><span>${ssrInterpolate(s.data.text)}</span>`);
        if (!!s.name) {
          _push(`<span>--</span>`);
        } else {
          _push(`<!---->`);
        ...
        if (!!s.name) {
          _push(`<span class="italic txt-2">${ssrInterpolate(s.name)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</li>`);
      ...
      _push(ssrRenderComponent(unref(Form), {
        class: "grid grid-cols-[1fr,auto,auto] gap-4",
        onSubmit
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<button class="bg-success" type="submit"${_scopeId}>Submit</button>`);
          } else {
            return [
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Shoutbox/index.vue");
...
const welcome = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-a75d3b4d"]]);
...
const nuxtErrorBoundary$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
...
const devOnly$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: devOnly
});
...
const serverPlaceholder$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
...
const component_vue3$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
...
defineAsyncComponent(() => import(
  './ProseBlockquote-a157b5e2.mjs'
  /* webpackChunkName: "components/prose-blockquote" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './ProseCode-c5a72f72.mjs'
  /* webpackChunkName: "components/prose-code" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './ProseCodeInline-5141bce7.mjs'
  /* webpackChunkName: "components/prose-code-inline" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './ProseH1-0791f532.mjs'
  /* webpackChunkName: "components/prose-h1" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './FlatCard-21621c86.mjs'
  /* webpackChunkName: "components/article-flat-card" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './Title-5bda246b.mjs'
  /* webpackChunkName: "components/article-title" */
).then((c) => c.default || c));
...
defineAsyncComponent(() => import(
  './ColorLink-9a795a83.mjs'
  /* webpackChunkName: "components/color-link" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './index-17c13956.mjs'
  /* webpackChunkName: "components/description" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './index-bd069b5f.mjs'
...
defineAsyncComponent(() => import(
  './Vpic-3d2c15c3.mjs'
  /* webpackChunkName: "components/gallery-hpic" */
).then(function(n) {
  return n.H;
}).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './Vpic-3d2c15c3.mjs'
  /* webpackChunkName: "components/gallery-vpic" */
).then(function(n) {
  return n.V;
}).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(function() {
...
defineAsyncComponent(() => import(
  './NavItemB-3e471c8c.mjs'
  /* webpackChunkName: "components/nav-item-b" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './index-f113998c.mjs'
  /* webpackChunkName: "components/nav-bar" */
).then(function(n) {
  return n.a;
}).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './index-b592cdb4.mjs'
  /* webpackChunkName: "components/prev-next-button" */
).then(function(n) {
  return n.b;
}).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './index-b592cdb4.mjs'
  /* webpackChunkName: "components/prev-next" */
).then(function(n) {
  return n.i;
}).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(function() {
...
defineAsyncComponent(() => import(
  './index-131bf715.mjs'
  /* webpackChunkName: "components/sparkle-instance" */
).then(function(n) {
  return n.S;
}).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './index-131bf715.mjs'
  /* webpackChunkName: "components/sparkle" */
).then(function(n) {
  return n.i;
}).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './index-f113998c.mjs'
  /* webpackChunkName: "components/switch" */
).then(function(n) {
  return n.i;
}).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './index-0ad9cbe7.mjs'
  /* webpackChunkName: "components/text" */
).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(function() {
  return index$1;
}).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './ContentDoc-34fa3ea1.mjs'
  /* webpackChunkName: "components/content-doc" */
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  './ContentList-09275c95.mjs'
...
defineAsyncComponent(() => import(
  '../server.mjs'
  /* webpackChunkName: "components/nuxt-loading-indicator" */
).then(function(n) {
  return n.n;
}).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(function() {
...
const ContentNavigation = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: _sfc_main
});

export { _sfc_main as default };
//# sourceMappingURL=ContentNavigation-7bb17fcb.mjs.map
