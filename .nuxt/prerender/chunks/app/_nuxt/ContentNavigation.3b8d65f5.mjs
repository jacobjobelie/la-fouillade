import { d as useNuxtApp, i as useState, c as useHead, f as useCookie, _ as _export_sfc, h as componentName, a as __nuxt_component_0$1$1 } from '../server.mjs';
import { useSSRContext, defineComponent, ref, onErrorCaptured, createElementBlock, defineAsyncComponent, toRefs, computed, useSlots, mergeProps, withCtx, createTextVNode, createVNode, createSlots, unref, renderSlot, toDisplayString, createElementVNode, h } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/vue/index.mjs';
import { u as useAsyncData, j as jsonStringify } from './query.37fcdf32.mjs';
import { hash } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/ohash/dist/index.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.1cd441ea.mjs';
import _sfc_main$6 from './index.ce8762a7.mjs';
import __nuxt_component_0$1 from './index.e22a7eff.mjs';
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderAttrs } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/vue/server-renderer/index.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.18c0bcc4.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import('./Hero.6138e40c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.bdabec57.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.15666352.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.bff1b8dc.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.494e6758.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.bc0c054b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./FlatCard.3069e6f1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./Title.f6174a9a.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => WithCover).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.ce8762a7.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => index).then((c) => c.default || c));
defineAsyncComponent(() => import('./ColorLink.39f07d4b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./index.37619ba1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./index.46ee0f73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./Vpic.152957eb.mjs').then((n) => n.H).then((c) => c.default || c));
defineAsyncComponent(() => import('./Vpic.152957eb.mjs').then((n) => n.V).then((c) => c.default || c));
defineAsyncComponent(() => import('./v1.c8f36b4e.mjs').then((n) => n.N).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.7377f952.mjs').then((n) => n.N).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.7377f952.mjs').then((n) => n.a).then((c) => c.default || c));
defineAsyncComponent(() => import('./v1.c8f36b4e.mjs').then((n) => n.v).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.90d3b313.mjs').then((n) => n.b).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.90d3b313.mjs').then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => Row).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.92832046.mjs').then((n) => n.S).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.92832046.mjs').then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.7377f952.mjs').then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => import('./index.e22a7eff.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentDoc.9642a8c6.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.0bc413cd.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentQuery.e992990c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRenderer.b4fc043b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRendererMarkdown.19034a6c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentSlot.8f1c9f90.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.965e4bcc.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.e84a14de.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH2.5a0952e5.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH3.5de4016b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH4.44b8b723.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH5.a0815f08.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.cde3ae47.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.8c16ffb8.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.02b9a271.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.4a8e4a29.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.66cb6783.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.27499a84.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.f86247b1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.f48683e0.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.510890aa.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.e25d55d3.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.13c2058c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.446bf670.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.004b74d2.mjs').then((c) => c.default || c));
...
const _sfc_main = defineComponent({
  ...
  render(ctx) {
    ...
    const renderLink = (link) => h(__nuxt_component_0$1$1, { to: link._path }, () => link.title);
...
//# sourceMappingURL=ContentNavigation.3b8d65f5.mjs.map
