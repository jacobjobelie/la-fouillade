import { _ as __nuxt_component_0 } from './index-f04b5126.mjs';
import { _ as __nuxt_component_0$1 } from './index-914e3ae6.mjs';
import { useSSRContext, mergeProps } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot } from 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/vue/server-renderer/index.mjs';
...
import 'file:///Users/selie/Documents/Hacks/la-fouillade/node_modules/@headlessui/vue/dist/headlessui.esm.js';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-12 px-8" }, _attrs))}><div class="h-full text-gray-400 text-left">`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid gap-4 grid-cols-1 grid-rows-[auto,1fr,auto] min-w-screen min-h-screen text-left justify-center dark:bg-dark-400 dark:text-light-400 bg-light-900 text-dark-400" }, _attrs))}><div class="mx-auto h-18 w-full &lt;lg:w-100vw &lt;sm:my-0 &lt;sm:px-0">`);
  _push(ssrRenderComponent(_component_NavBar, null, null, _parent));
  _push(`</div><div class="w-full mx-auto &lt;lg:w-100vw">`);
...
//# sourceMappingURL=default-ef7f472f.mjs.map
