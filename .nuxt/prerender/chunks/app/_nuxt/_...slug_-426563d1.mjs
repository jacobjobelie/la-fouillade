...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full mx-auto py-6" }, _attrs))} data-v-ccda3b26><div class="relative w-full h-full grid items-center place-items-center" data-v-ccda3b26><div class="w-full h-full grid gap-4" data-v-ccda3b26><div class="absolute w-full h-full grid gap-2" data-v-ccda3b26><img class="w-full h-full object-cover"${ssrRenderAttr("src", _imports_0)} data-v-ccda3b26></div><div class="relative flex flex-col z-10 text-container gap-8" data-v-ccda3b26><div class="relative w-full flex items-center justify-center flex-col gap-4" data-v-ccda3b26><div class="absolute w-11/12 h-1/2 bg-yellow-300 bg-opacity-50 translate-y-1/2 rounded-2xl" data-v-ccda3b26></div><div class="absolute w-11/12 h-1/2 bg-green-500 bg-opacity-20 translate-y-1/2 rounded-2xl" data-v-ccda3b26></div><div class="w-9/12 py-8 bg-gray-800 text-light-800 rounded-2xl flex items-center justify-center border-green-300 border-4 z-10" data-v-ccda3b26>`);
      _push(ssrRenderComponent(_component_Text, { h1: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`ce\xE7i n&#39;est pas une page`);
          } else {
            return [
              createTextVNode("ce\xE7i n'est pas une page")
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/travel/[...slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ccda3b26"]]);

export { ____slug_ as default };
//# sourceMappingURL=_...slug_-426563d1.mjs.map
