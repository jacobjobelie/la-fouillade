import { getCurrentInstance, toRef, isRef, inject, ref, defineAsyncComponent, version as version$7, defineComponent, h, computed, unref, Suspense, nextTick, Transition, provide, reactive, resolveComponent, shallowRef, useSSRContext, createApp, onErrorCaptured, withCtx, createVNode } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/unctx/dist/index.mjs';
import destr from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/destr/dist/index.mjs';
import { hasProtocol, parseURL, joinURL, isEqual as isEqual$1 } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/ufo/dist/index.mjs';
import { createError as createError$1, sendRedirect, appendHeader } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/h3/dist/index.mjs';
import { useHead as useHead$1, createHead as createHead$1 } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/@unhead/dom/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/vue-router/dist/vue-router.node.mjs';
import { parse, serialize } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/cookie-es/dist/index.mjs';
import { isEqual } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/ohash/dist/index.mjs';
import crossFetch, { Headers as Headers$1 } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/unenv/runtime/npm/cross-fetch.mjs';
import require$$2 from 'events';
import require$$1 from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/unenv/runtime/npm/debug.mjs';
import require$$1$1 from 'util';
import require$$0$3 from 'crypto';
import require$$2$1 from 'url';
import require$$0$1 from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/bufferutil/index.js';
import require$$0$2 from 'buffer';
import require$$5 from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/utf-8-validate/index.js';
import require$$3 from 'http';
import require$$4 from 'https';
import require$$1$2 from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/typedarray-to-buffer/index.js';
import require$$2$2 from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/yaeti/index.js';
import { defu } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/defu/dist/defu.mjs';
import { config as config$1, library } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/@fortawesome/fontawesome-svg-core/index.mjs';
import { FontAwesomeIcon } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/@fortawesome/vue-fontawesome/index.js';
import { fas } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/@fortawesome/free-solid-svg-icons/index.mjs';
import { fab } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/@fortawesome/free-brands-svg-icons/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs } from 'file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/vue/server-renderer/index.mjs';
...
defuFn(inlineConfig);
const components = {
  Hero: defineAsyncComponent(() => import('./_nuxt/Hero.ecad2c06.mjs').then((c) => c.default || c)),
  ProseA: defineAsyncComponent(() => import('./_nuxt/ProseA.2b7aa5b7.mjs').then((c) => c.default || c)),
  ProseBlockquote: defineAsyncComponent(() => import('./_nuxt/ProseBlockquote.67818778.mjs').then((c) => c.default || c)),
  ProseCode: defineAsyncComponent(() => import('./_nuxt/ProseCode.26380a58.mjs').then((c) => c.default || c)),
  ProseCodeInline: defineAsyncComponent(() => import('./_nuxt/ProseCodeInline.72bbe8de.mjs').then((c) => c.default || c)),
  ProseH1: defineAsyncComponent(() => import('./_nuxt/ProseH1.c9aacedf.mjs').then((c) => c.default || c)),
  ContentDoc: defineAsyncComponent(() => import('./_nuxt/ContentDoc.7c8607be.mjs').then((c) => c.default || c)),
  ContentList: defineAsyncComponent(() => import('./_nuxt/ContentList.b522245f.mjs').then((c) => c.default || c)),
  ContentNavigation: defineAsyncComponent(() => import('./_nuxt/ContentNavigation.49f63ca8.mjs').then((c) => c.default || c)),
  ContentQuery: defineAsyncComponent(() => import('./_nuxt/ContentQuery.7f69e367.mjs').then((c) => c.default || c)),
  ContentRenderer: defineAsyncComponent(() => import('./_nuxt/ContentRenderer.7a1d50fb.mjs').then((c) => c.default || c)),
  ContentRendererMarkdown: defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown.04aa768c.mjs').then((c) => c.default || c)),
  ContentSlot: defineAsyncComponent(() => import('./_nuxt/ContentSlot.490e6e6e.mjs').then((c) => c.default || c)),
  ...
  Markdown: defineAsyncComponent(() => import('./_nuxt/Markdown.8169a2b4.mjs').then((c) => c.default || c)),
  ProseEm: defineAsyncComponent(() => import('./_nuxt/ProseEm.2f37cbf5.mjs').then((c) => c.default || c)),
  ProseH2: defineAsyncComponent(() => import('./_nuxt/ProseH2.cffc235e.mjs').then((c) => c.default || c)),
  ProseH3: defineAsyncComponent(() => import('./_nuxt/ProseH3.661b0f5c.mjs').then((c) => c.default || c)),
  ProseH4: defineAsyncComponent(() => import('./_nuxt/ProseH4.c2b768df.mjs').then((c) => c.default || c)),
  ProseH5: defineAsyncComponent(() => import('./_nuxt/ProseH5.3b7e598d.mjs').then((c) => c.default || c)),
  ProseH6: defineAsyncComponent(() => import('./_nuxt/ProseH6.e1e0802f.mjs').then((c) => c.default || c)),
  ProseHr: defineAsyncComponent(() => import('./_nuxt/ProseHr.36ec790e.mjs').then((c) => c.default || c)),
  ProseImg: defineAsyncComponent(() => import('./_nuxt/ProseImg.4debdb73.mjs').then((c) => c.default || c)),
  ProseLi: defineAsyncComponent(() => import('./_nuxt/ProseLi.8e75d9ab.mjs').then((c) => c.default || c)),
  ProseOl: defineAsyncComponent(() => import('./_nuxt/ProseOl.7525f02b.mjs').then((c) => c.default || c)),
  ProseP: defineAsyncComponent(() => import('./_nuxt/ProseP.c78d18da.mjs').then((c) => c.default || c)),
  ProseStrong: defineAsyncComponent(() => import('./_nuxt/ProseStrong.08b05f32.mjs').then((c) => c.default || c)),
  ProseTable: defineAsyncComponent(() => import('./_nuxt/ProseTable.f545884c.mjs').then((c) => c.default || c)),
  ProseTbody: defineAsyncComponent(() => import('./_nuxt/ProseTbody.eacdc04a.mjs').then((c) => c.default || c)),
  ProseTd: defineAsyncComponent(() => import('./_nuxt/ProseTd.709acdb1.mjs').then((c) => c.default || c)),
  ProseTh: defineAsyncComponent(() => import('./_nuxt/ProseTh.e85b81c7.mjs').then((c) => c.default || c)),
  ProseThead: defineAsyncComponent(() => import('./_nuxt/ProseThead.9f8ef871.mjs').then((c) => c.default || c)),
  ProseTr: defineAsyncComponent(() => import('./_nuxt/ProseTr.ea11bca3.mjs').then((c) => c.default || c)),
  ProseUl: defineAsyncComponent(() => import('./_nuxt/ProseUl.f536003b.mjs').then((c) => c.default || c))
};
...
const node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_D7WGfuP1A0 = defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp._useHead = useHead$1;
  {
    nuxtApp.ssrContext.renderMeta = async () => {
      const { renderSSRHead } = await import('file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/@unhead/ssr/dist/index.mjs');
...
const _routes = [
  {
    name: (_a = __nuxt_page_meta$9 == null ? void 0 : __nuxt_page_meta$9.name) != null ? _a : "slug",
    path: (_b = __nuxt_page_meta$9 == null ? void 0 : __nuxt_page_meta$9.path) != null ? _b : "/:slug(.*)*",
    ...
    component: () => import('./_nuxt/_...slug_.43f1902b.mjs').then((m) => m.default || m)
  },
  {
    name: (_c = __nuxt_page_meta$8 == null ? void 0 : __nuxt_page_meta$8.name) != null ? _c : "about",
    path: (_d = __nuxt_page_meta$8 == null ? void 0 : __nuxt_page_meta$8.path) != null ? _d : "/about",
    ...
    component: () => import('./_nuxt/index.1ea4f198.mjs').then((m) => m.default || m)
  },
  {
    name: (_e = __nuxt_page_meta$7 == null ? void 0 : __nuxt_page_meta$7.name) != null ? _e : "about-zh",
    path: (_f = __nuxt_page_meta$7 == null ? void 0 : __nuxt_page_meta$7.path) != null ? _f : "/about/zh",
    ...
    component: () => import('./_nuxt/zh.47bcb060.mjs').then((m) => m.default || m)
  },
  {
    name: (_g = __nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.name) != null ? _g : "article-slug",
    path: (_h = __nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.path) != null ? _h : "/article/:slug(.*)*",
    file: "/Users/selie/Documents/Hacks/NuxtSupabaseApp/pages/article/[...slug].vue",
    children: [],
    meta: __nuxt_page_meta$6,
    alias: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.alias) || [],
    redirect: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.redirect) || void 0,
    component: () => import('./_nuxt/_...slug_.6a517913.mjs').then((m) => m.default || m)
  },
  {
    name: (_i = __nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.name) != null ? _i : "article",
    path: (_j = __nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.path) != null ? _j : "/article",
    file: "/Users/selie/Documents/Hacks/NuxtSupabaseApp/pages/article/index.vue",
    children: [],
    meta: __nuxt_page_meta$5,
    alias: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.alias) || [],
    redirect: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.redirect) || void 0,
    component: () => import('./_nuxt/index.1829ab34.mjs').then((m) => m.default || m)
  },
  {
    name: (_k = __nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.name) != null ? _k : "components",
    path: (_l = __nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.path) != null ? _l : "/components",
    file: "/Users/selie/Documents/Hacks/NuxtSupabaseApp/pages/components.vue",
    children: [],
    meta: __nuxt_page_meta$4,
    alias: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.alias) || [],
    redirect: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.redirect) || void 0,
    component: () => import('./_nuxt/components.4285fc23.mjs').then((m) => m.default || m)
  },
  {
    name: (_m = __nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) != null ? _m : "gallery",
    path: (_n = __nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) != null ? _n : "/gallery",
    file: "/Users/selie/Documents/Hacks/NuxtSupabaseApp/pages/gallery.vue",
    children: [],
    meta: __nuxt_page_meta$3,
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./_nuxt/gallery.c6d8ebfc.mjs').then((m) => m.default || m)
  },
  {
    name: (_o = __nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) != null ? _o : "game-gobang",
    path: (_p = __nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) != null ? _p : "/game/gobang",
    file: "/Users/selie/Documents/Hacks/NuxtSupabaseApp/pages/game/gobang.vue",
    children: [],
    meta: __nuxt_page_meta$2,
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./_nuxt/gobang.8342ca5b.mjs').then((m) => m.default || m)
  },
  {
    name: (_q = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) != null ? _q : "index",
    path: (_r = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) != null ? _r : "/",
    file: "/Users/selie/Documents/Hacks/NuxtSupabaseApp/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/index.5b1b60fd.mjs').then((m) => m.default || m)
  },
  {
    name: (_s = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) != null ? _s : "projects",
    path: (_t = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) != null ? _t : "/projects",
    file: "/Users/selie/Documents/Hacks/NuxtSupabaseApp/pages/projects.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/projects.a0a10153.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth.69f4249c.mjs')
};
...
const resolveFetch$3 = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter$e(void 0, void 0, void 0, function* () {
      return yield (yield import('file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/unenv/runtime/npm/cross-fetch.mjs')).fetch(...args);
    });
  } else {
    _fetch = fetch;
  }
  ...
  then(onfulfilled, onrejected) {
    ...
    let res = _fetch(this.url.toString(), {
      ...
      if (res2.ok) {
        ...
        if (error && this.allowEmpty && ((_c2 = error === null || error === void 0 ? void 0 : error.details) === null || _c2 === void 0 ? void 0 : _c2.includes("Results contain 0 rows"))) {
          error = null;
          status = 200;
          statusText = "OK";
        }
...
const resolveResponse = () => __awaiter$9(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import('file:///Users/selie/Documents/Hacks/NuxtSupabaseApp/node_modules/unenv/runtime/npm/cross-fetch.mjs')).Response;
  }
  return Response;
});
...
function _request(fetcher, method, url2, options) {
  ...
  return __awaiter$3(this, void 0, void 0, function* () {
    const headers = (_a2 = options === null || options === void 0 ? void 0 : options.headers) !== null && _a2 !== void 0 ? _a2 : {};
    if (options === null || options === void 0 ? void 0 : options.jwt) {
      headers["Authorization"] = `Bearer ${options.jwt}`;
    }
    const qs = (_b2 = options === null || options === void 0 ? void 0 : options.query) !== null && _b2 !== void 0 ? _b2 : {};
    ...
    return __awaiter$1(this, void 0, void 0, function* () {
      try {
        ...
        const { data, error } = yield _request(this.fetch, "POST", `${this.url}/verify`, {
          ...
          redirectTo: (_b2 = params.options) === null || _b2 === void 0 ? void 0 : _b2.redirectTo,
          xform: _sessionResponse
        });
        if (error) {
          throw error;
  ...
  _recoverAndRefresh() {
    ...
    return __awaiter$1(this, void 0, void 0, function* () {
      try {
        ...
        const timeNow = Math.round(Date.now() / 1e3);
        if (((_a2 = currentSession.expires_at) !== null && _a2 !== void 0 ? _a2 : Infinity) < timeNow + EXPIRY_MARGIN) {
...
class SupabaseClient {
  constructor(supabaseUrl, supabaseKey, options) {
    ...
    this.fetch = fetchWithAuth(supabaseKey, this._getAccessToken.bind(this), (_g2 = settings.global) === null || _g2 === void 0 ? void 0 : _g2.fetch);
    this.realtime = this._initRealtimeClient(Object.assign({ headers: this.headers }, settings.realtime));
    this.rest = new PostgrestClient(`${_supabaseUrl}/rest/v1`, {
      headers: this.headers,
      schema: (_h2 = settings.db) === null || _h2 === void 0 ? void 0 : _h2.schema,
      fetch: this.fetch
    });
...
const useSupabaseClient = () => {
  ...
  const recreateClient = ((_a2 = nuxtApp._supabaseClient) == null ? void 0 : _a2.headers.Authorization) !== Authorization;
...
const layouts = {
  default: () => import('./_nuxt/default.18686bfd.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.fbebc938.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useRoute as b, useHead as c, useNuxtApp as d, entry$1 as default, createError as e, useCookie as f, useRequestEvent as g, componentName as h, useState as i, defineNuxtRouteMiddleware as j, useSupabaseUser as k, nuxtLink as l, layout as m, navigateTo as n, nuxtLoadingIndicator as o, page as p, useRuntimeConfig as u };
