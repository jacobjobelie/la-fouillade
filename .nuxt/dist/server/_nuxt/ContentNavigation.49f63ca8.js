import { f as useCookie, a as __nuxt_component_0$2, _ as _export_sfc, c as useHead, d as useNuxtApp, h as componentName, i as useState } from "../server.mjs";
import { defineComponent, mergeProps, withCtx, createTextVNode, createVNode, useSSRContext, computed, createSlots, unref, renderSlot, toDisplayString, resolveComponent, ref, onErrorCaptured, createElementBlock, createElementVNode, h, defineAsyncComponent, toRefs, useSlots } from "vue";
import { j as jsonStringify, u as useAsyncData } from "./query.a4f9a6f2.js";
import { hash } from "ohash";
import "destr";
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB, u as useContentDisabled } from "./utils.10742fcf.js";
import "./Hero.ecad2c06.js";
import "./ProseA.2b7aa5b7.js";
import "./ProseBlockquote.67818778.js";
import "./ProseCode.26380a58.js";
import "./ProseCodeInline.72bbe8de.js";
import "./ProseH1.c9aacedf.js";
import "./FlatCard.3069e6f1.js";
import "./Title.97da57da.js";
import _sfc_main$7 from "./index.ce8762a7.js";
import __nuxt_component_0$1 from "./index.b81898ae.js";
...
import "./index.38323cb8.js";
import "./Vpic.28f57259.js";
import "./index.004ef289.js";
import "./index.803cdebe.js";
import "./index.d288e808.js";
import "./ContentDoc.7c8607be.js";
import "./ContentList.b522245f.js";
import "./ContentQuery.7f69e367.js";
import "./ContentRenderer.7a1d50fb.js";
import "./ContentRendererMarkdown.04aa768c.js";
import "./ContentSlot.490e6e6e.js";
import "./DocumentDrivenEmpty.b1426f16.js";
import "./DocumentDrivenNotFound.b4d3af5a.js";
import "./Markdown.8169a2b4.js";
import "./ProseEm.2f37cbf5.js";
import "./ProseH2.cffc235e.js";
import "./ProseH3.661b0f5c.js";
import "./ProseH4.c2b768df.js";
import "./ProseH5.3b7e598d.js";
import "./ProseH6.e1e0802f.js";
import "./ProseHr.36ec790e.js";
import "./ProseImg.4debdb73.js";
import "./ProseLi.8e75d9ab.js";
import "./ProseOl.7525f02b.js";
import "./ProseP.c78d18da.js";
import "./ProseStrong.08b05f32.js";
import "./ProseTable.f545884c.js";
import "./ProseTbody.eacdc04a.js";
import "./ProseTd.709acdb1.js";
import "./ProseTh.e85b81c7.js";
import "./ProseThead.9f8ef871.js";
import "./ProseTr.ea11bca3.js";
import "./ProseUl.f536003b.js";
import "ofetch";
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./client-db.6523458c.js").then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import("./Hero.ecad2c06.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseA.2b7aa5b7.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseBlockquote.67818778.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseCode.26380a58.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseCodeInline.72bbe8de.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH1.c9aacedf.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./FlatCard.3069e6f1.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./Title.97da57da.js").then((c) => c.default || c));
...
defineAsyncComponent(() => import("./index.d1cf99d6.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./index.38323cb8.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./Vpic.28f57259.js").then((n) => n.H).then((c) => c.default || c));
defineAsyncComponent(() => import("./Vpic.28f57259.js").then((n) => n.V).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => NavItem).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.004ef289.js").then((n) => n.N).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.004ef289.js").then((n) => n.a).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.803cdebe.js").then((n) => n.b).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.803cdebe.js").then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => Row).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.d288e808.js").then((n) => n.S).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.d288e808.js").then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.004ef289.js").then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.b81898ae.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentDoc.7c8607be.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentList.b522245f.js").then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentQuery.7f69e367.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentRenderer.7a1d50fb.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentRendererMarkdown.04aa768c.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentSlot.490e6e6e.js").then((c) => c.default || c));
...
defineAsyncComponent(() => import("./Markdown.8169a2b4.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseEm.2f37cbf5.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH2.cffc235e.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH3.661b0f5c.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH4.c2b768df.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH5.3b7e598d.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH6.e1e0802f.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseHr.36ec790e.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseImg.4debdb73.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseLi.8e75d9ab.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseOl.7525f02b.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseP.c78d18da.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseStrong.08b05f32.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTable.f545884c.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTbody.eacdc04a.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTd.709acdb1.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTh.e85b81c7.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseThead.9f8ef871.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTr.ea11bca3.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseUl.f536003b.js").then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.49f63ca8.js.map
