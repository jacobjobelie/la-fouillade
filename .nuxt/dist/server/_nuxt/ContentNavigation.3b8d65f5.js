import { f as useCookie, _ as _export_sfc, c as useHead, d as useNuxtApp, h as componentName, i as useState, a as __nuxt_component_0$2 } from "../server.mjs";
import { defineComponent, mergeProps, withCtx, createTextVNode, createVNode, useSSRContext, computed, createSlots, unref, renderSlot, toDisplayString, ref, onErrorCaptured, createElementBlock, createElementVNode, h, defineAsyncComponent, toRefs, useSlots } from "vue";
import { j as jsonStringify, u as useAsyncData } from "./query.37fcdf32.js";
import { hash } from "ohash";
import "destr";
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB, u as useContentDisabled } from "./utils.1cd441ea.js";
import "./Hero.6138e40c.js";
import "./ProseA.bdabec57.js";
import "./ProseBlockquote.15666352.js";
import "./ProseCode.bff1b8dc.js";
import "./ProseCodeInline.494e6758.js";
import "./ProseH1.bc0c054b.js";
import "./FlatCard.3069e6f1.js";
import "./Title.f6174a9a.js";
import _sfc_main$6 from "./index.ce8762a7.js";
import __nuxt_component_0$1 from "./index.e22a7eff.js";
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderAttrs } from "vue/server-renderer";
import "./ColorLink.39f07d4b.js";
import "./index.37619ba1.js";
import "./index.46ee0f73.js";
import "./Vpic.152957eb.js";
import "./v1.c8f36b4e.js";
import "./index.7377f952.js";
import "./index.90d3b313.js";
import "./index.92832046.js";
import "./ContentDoc.9642a8c6.js";
import "./ContentList.0bc413cd.js";
import "./ContentQuery.e992990c.js";
import "./ContentRenderer.b4fc043b.js";
import "./ContentRendererMarkdown.19034a6c.js";
import "./ContentSlot.8f1c9f90.js";
import "./DocumentDrivenEmpty.b1426f16.js";
import "./DocumentDrivenNotFound.b4d3af5a.js";
import "./Markdown.965e4bcc.js";
import "./ProseEm.e84a14de.js";
import "./ProseH2.5a0952e5.js";
import "./ProseH3.5de4016b.js";
import "./ProseH4.44b8b723.js";
import "./ProseH5.a0815f08.js";
import "./ProseH6.cde3ae47.js";
import "./ProseHr.8c16ffb8.js";
import "./ProseImg.4debdb73.js";
import "./ProseLi.02b9a271.js";
import "./ProseOl.4a8e4a29.js";
import "./ProseP.66cb6783.js";
import "./ProseStrong.27499a84.js";
import "./ProseTable.f86247b1.js";
import "./ProseTbody.f48683e0.js";
import "./ProseTd.510890aa.js";
import "./ProseTh.e25d55d3.js";
import "./ProseThead.13c2058c.js";
import "./ProseTr.446bf670.js";
import "./ProseUl.004b74d2.js";
import "ofetch";
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./client-db.18c0bcc4.js").then((m) => m.generateNavigation);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    src: null,
    hdivider: { type: Boolean, default: false },
    hdw: { default: 1 },
    hdcolor: null,
    fdivider: { type: Boolean, default: false },
    fdw: { default: 1 },
    fdcolor: null
  },
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Card, mergeProps({
        class: ["h-300px w-250px bg-no-repeat bg-center bg-cover", props.src]
      }, _attrs), {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-1rem backdrop-filter backdrop-blur-md rounded-b-1rem border-t-gray-400 border-t-1 border-opacity-80"${_scopeId}><div class="flex justify-between items-center"${_scopeId}><div${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Text, {
              sm: "",
              class: "text-gray-300"
            }, {
            ...
            return [
              createVNode("div", { class: "p-1rem backdrop-filter backdrop-blur-md rounded-b-1rem border-t-gray-400 border-t-1 border-opacity-80" }, [
...
const WithCover_vue_vue_type_style_index_0_scope_true_lang = "";
const _sfc_setup$5 = _sfc_main$5.setup;
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Card/WithCover.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const WithCover = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: _sfc_main$5
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isRounded = computed(() => {
      if (props.language || props.filename)
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Card, mergeProps({ class: "my-6" }, _attrs), createSlots({
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="${ssrRenderClass([unref(isRounded), "px-4 py-2 bg-dark-700 overflow-auto"])}"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", {
                class: ["px-4 py-2 bg-dark-700 overflow-auto", unref(isRounded)]
              }, [
            ...
            if (_push2) {
              ...
              return [
                createVNode("div", { class: "flex-between px-4 py-2 rounded-t-1rem bg-dark-300 text-gray-300" }, [
                  ...
                  createVNode("div", { class: "flex-1 text-center" }, toDisplayString(__props.filename ? __props.filename : ""), 1),
                  createVNode("div", { class: "flex-1 text-right" }, toDisplayString(__props.language), 1)
                ])
              ];
            }
          }),
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CodeBlock/index.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["flex items-center", props.css]
      }, _attrs))}>`);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Row.vue");
...
const welcome = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ff49b321"]]);
...
defineAsyncComponent(() => import("./Hero.6138e40c.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseA.bdabec57.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseBlockquote.15666352.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseCode.bff1b8dc.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseCodeInline.494e6758.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH1.bc0c054b.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./FlatCard.3069e6f1.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./Title.f6174a9a.js").then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => WithCover).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.ce8762a7.js").then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => index).then((c) => c.default || c));
defineAsyncComponent(() => import("./ColorLink.39f07d4b.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./index.37619ba1.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./index.46ee0f73.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./Vpic.152957eb.js").then((n) => n.H).then((c) => c.default || c));
defineAsyncComponent(() => import("./Vpic.152957eb.js").then((n) => n.V).then((c) => c.default || c));
defineAsyncComponent(() => import("./v1.c8f36b4e.js").then((n) => n.N).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.7377f952.js").then((n) => n.N).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.7377f952.js").then((n) => n.a).then((c) => c.default || c));
defineAsyncComponent(() => import("./v1.c8f36b4e.js").then((n) => n.v).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.90d3b313.js").then((n) => n.b).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.90d3b313.js").then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => Row).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.92832046.js").then((n) => n.S).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.92832046.js").then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.7377f952.js").then((n) => n.i).then((c) => c.default || c));
defineAsyncComponent(() => import("./index.e22a7eff.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentDoc.9642a8c6.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentList.0bc413cd.js").then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentQuery.e992990c.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentRenderer.b4fc043b.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentRendererMarkdown.19034a6c.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ContentSlot.8f1c9f90.js").then((c) => c.default || c));
...
defineAsyncComponent(() => import("./Markdown.965e4bcc.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseEm.e84a14de.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH2.5a0952e5.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH3.5de4016b.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH4.44b8b723.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH5.a0815f08.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseH6.cde3ae47.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseHr.8c16ffb8.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseImg.4debdb73.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseLi.02b9a271.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseOl.4a8e4a29.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseP.66cb6783.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseStrong.27499a84.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTable.f86247b1.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTbody.f48683e0.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTd.510890aa.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTh.e25d55d3.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseThead.13c2058c.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseTr.446bf670.js").then((c) => c.default || c));
defineAsyncComponent(() => import("./ProseUl.004b74d2.js").then((c) => c.default || c));
...
defineAsyncComponent(() => Promise.resolve().then(() => clientOnly).then((c) => c.default || c));
...
defineAsyncComponent(() => Promise.resolve().then(() => component_vue3$1).then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.3b8d65f5.js.map
